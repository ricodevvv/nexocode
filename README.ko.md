...
# 패키지 매니저
npm i -g nexocode-ai@latest        # bun/pnpm/yarn 도 가능
scoop install nexocode             # Windows
choco install nexocode             # Windows
brew install ricodevvv/tap/nexocode # macOS 및 Linux (권장, 항상 최신)
brew install nexocode              # macOS 및 Linux (공식 brew formula, 업데이트 빈도 낮음)
sudo pacman -S nexocode            # Arch Linux (Stable)
paru -S nexocode-bin               # Arch Linux (Latest from AUR)
mise use -g nexocode               # 어떤 OS든
nix run nixpkgs#nexocode           # 또는 github:ricodevvv/nexocode 로 최신 dev 브랜치
```
...
NexoCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/ricodevvv/nexocode/releases) 에서 직접 다운로드하거나 [nexocode.ai/download](https://nexocode.ai/download) 를 이용하세요.
...
NexoCode 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://nexocode.ai/docs/agents) 에 대해 더 알아보세요.

### 문서

NexoCode 설정에 대한 자세한 내용은 [**문서**](https://nexocode.ai/docs) 를 참고하세요.

### 기여하기

NexoCode 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### NexoCode 기반으로 만들기

NexoCode 와 관련된 프로젝트를 진행하면서 이름에 "nexocode"(예: "nexocode-dashboard" 또는 "nexocode-mobile") 를 포함한다면, README 에 해당 프로젝트가 NexoCode 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/nexocode) | [X.com](https://x.com/nexocode)

...
brew install ricodevvv/tap/nexocode # macOS og Linux (anbefalet, altid up to date)
brew install nexocode              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
NexoCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/ricodevvv/nexocode/releases) eller [nexocode.ai/download](https://nexocode.ai/download).
...
1. `$NEXOCODE_INSTALL_DIR` - Tilpasset installationsmappe
...
NexoCode har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://nexocode.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af NexoCode, [**se vores docs**](https://nexocode.ai/docs).

### Bidrag

Hvis du vil bidrage til NexoCode, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på NexoCode

Hvis du arbejder på et projekt der er relateret til NexoCode og bruger "nexocode" som en del af navnet; f.eks. "nexocode-dashboard" eller "nexocode-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af NexoCode-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/nexocode) | [X.com](https://x.com/nexocode)

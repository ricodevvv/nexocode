...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/ricodevvv/nexocode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for ricodevvv/nexocode...\n")
...
console.log("Fetching npm all-time downloads for nexocode-ai...\n")
const npmDownloads = await fetchNpmDownloads("nexocode-ai")

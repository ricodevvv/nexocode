...
Generates UPCOMING_CHANGELOG.md by running the nexocode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for nexocode run (default: low)
      --quiet            Suppress nexocode command output unless it fails

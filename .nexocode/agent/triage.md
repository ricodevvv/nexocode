...
Desktop application and browser-based app issues, including `nexocode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core nexocode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

NexoCode Zen, NexoCode Go, and billing issues.

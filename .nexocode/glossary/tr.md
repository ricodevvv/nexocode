...
- PR #15835: https://github.com/ricodevvv/nexocode/pull/15835

## Do Not Translate (Locale Additions)

- `NexoCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `nexocode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `NexoCode` in prose, `nexocode` only for exact technical identifiers
...
- Avoid changing `nexocode` to `NexoCode` inside commands, URLs, package names, or code literals

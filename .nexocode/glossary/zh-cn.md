...
- PR #13942: https://github.com/ricodevvv/nexocode/pull/13942

## Do Not Translate (Locale Additions)

- `NexoCode` (preserve casing in prose; keep `nexocode` only when it is part of commands, package names, paths, or code)
- `NexoCode Zen`
- `NexoCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `nexocode` in prose when referring to the product name; use `NexoCode`

...
Use this folder for locale-specific translation guidance that supplements `.nexocode/agent/translator.md`.
...
- PR #12345: https://github.com/ricodevvv/nexocode/pull/12345

## Do Not Translate (Locale Additions)

- `NexoCode` (preserve casing)

...
- PR #10809: https://github.com/ricodevvv/nexocode/pull/10809
- PR #11496: https://github.com/ricodevvv/nexocode/pull/11496

## Do Not Translate (Locale Additions)

- `NexoCode` (preserve casing in prose; keep `nexocode` only in commands, package names, paths, or code)
- `NexoCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`

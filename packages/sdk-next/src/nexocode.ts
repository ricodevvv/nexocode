import { NexoCode } from "@nexocode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@nexocode-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("NexoCode.create")(function* () {
  ...
  const client = yield* NexoCode.make({ baseUrl: "http://nexocode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@nexocode-ai/sdk-next/NexoCode") {}

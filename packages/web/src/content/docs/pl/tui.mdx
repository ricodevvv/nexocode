---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala nexocode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

nexocode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie nexocode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI nexocode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do nexocode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij nexocode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `nexocode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo NexoCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `nexocode.default`.

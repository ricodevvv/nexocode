...
Utwórz `.nexocode/commands/test.md`:
...
Możesz zdefiniować polecenia w `nexocode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji nexocode:
...
- Globalnie: `~/.config/nexocode/commands/`
- Na projekt: `.nexocode/commands/`
...
nexocode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).

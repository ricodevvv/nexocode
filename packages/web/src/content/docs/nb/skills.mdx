...
Agentferdigheter lar NexoCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går nexocode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
nexocode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `nexocode.json`:

...
Opprett `.nexocode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom NexoCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i NexoCode [config](/docs/config):
...
- Per prosjekt: `.nexocode/commands/`
...
NexoCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).

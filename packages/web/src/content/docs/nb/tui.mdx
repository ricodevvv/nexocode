---
title: TUI
description: Bruke nexocode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NexoCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre NexoCode starter TUI for gjeldende katalog.
...
Når du bruker NexoCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til NexoCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt NexoCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `nexocode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge NexoCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `nexocode.default`.

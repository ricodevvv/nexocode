---
title: Teilen
description: Teile NexoCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu NexoCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht NexoCode Folgendes:
...
NexoCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt NexoCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`nexocode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du nexocode in deiner Organisation einsetzt.

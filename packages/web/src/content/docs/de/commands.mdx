...
Erstellen Sie `.nexocode/commands/test.md`:

```md title=".nexocode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die NexoCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem NexoCode [config](/docs/config):

```json title="nexocode.jsonc" {4-12}
{
...
- Global: `~/.config/nexocode/commands/`
- Pro Projekt: `.nexocode/commands/`

```markdown title="~/.config/nexocode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".nexocode/commands/component.md"
---
...
```md title=".nexocode/commands/create-file.md"
---
...
```md title=".nexocode/commands/analyze-coverage.md"
---
...
```md title=".nexocode/commands/review-changes.md"
---
...
```md title=".nexocode/commands/review-component.md"
---
...
NexoCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).

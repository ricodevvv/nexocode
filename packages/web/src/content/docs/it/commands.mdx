...
Crea `.nexocode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di NexoCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di NexoCode:
...
- Globale: `~/.config/nexocode/commands/`
- Per progetto: `.nexocode/commands/`
...
nexocode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).

---
title: Paylasim
description: nexocode konusmalarini genel baglantilarla paylasin.
---

nexocode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda nexocode:
...
nexocode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak nexocode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `nexocode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda nexocode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).

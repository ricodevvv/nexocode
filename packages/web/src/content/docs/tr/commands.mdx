...
`.nexocode/commands/test.md` oluştur:
...
nexocode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

nexocode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/nexocode/commands/`
- Proje başına: `.nexocode/commands/`
...
nexocode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).

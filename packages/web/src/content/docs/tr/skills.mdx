...
Ajan becerileri, nexocode'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
nexocode su konumlari tarar:

- Proje konfigurasyonu: `.nexocode/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/nexocode/skills/<name>/SKILL.md`
...
Proje yerel yollarinda nexocode, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.nexocode/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/nexocode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.nexocode/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
nexocode, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`nexocode.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`nexocode.json` icinde):

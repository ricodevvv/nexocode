---
title: Özel Araçlar
description: LLM'un nexocode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. nexocode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.nexocode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/nexocode/tools/` içine yerleştirerek.

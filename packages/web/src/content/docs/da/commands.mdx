...
Opret `.nexocode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem NexoCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din NexoCode [config](/docs/config):
...
- Globalt: `~/.config/nexocode/commands/`
- Pr. projekt: `.nexocode/commands/`
...
nexocode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).

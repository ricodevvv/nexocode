---
title: TUI
description: Brug af NexoCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NexoCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre NexoCode starter TUI for den nuværende mappe.
...
Når du bruger NexoCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til NexoCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut NexoCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `nexocode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe NexoCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `nexocode.default`.

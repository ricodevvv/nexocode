...
Brug den til at bygge integrasjoner og kontrollere nexocode programmatisk.
...
Opret en forekomst av nexocode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `nexocode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av nexocode, kan du oprete en klientforekomst for at koble til den:

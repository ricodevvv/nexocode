...
Her er alle de innebygde verktøyene som er tilgængelige i NexoCode.
...
:::note
Dette verktøyet er bare tilgængelig når `NEXOCODE_EXPERIMENTAL_LSP_TOOL=true` (eller `NEXOCODE_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger NexoCode-leverandøren eller når miljøvariabelen `NEXOCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).

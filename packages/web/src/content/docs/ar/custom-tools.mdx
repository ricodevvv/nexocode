...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في nexocode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في nexocode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.nexocode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/nexocode/tools/`.

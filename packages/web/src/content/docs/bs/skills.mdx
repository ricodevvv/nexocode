...
Agent skills omogucavaju NexoCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
NexoCode pretrazuje ove lokacije:

- Konfiguracija projekta: `.nexocode/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/nexocode/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, NexoCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.nexocode/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/nexocode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.nexocode/skills/git-release/SKILL.md` ovako:
...
NexoCode navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `nexocode.json`:
...
**Za ugradene agente** (u `nexocode.json`):

...
NexoCode Go je povoljna pretplata od **$10/mjesečno** koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u NexoCode-u. Pretplatite se na NexoCode Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili NexoCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa NexoCode-om.
:::
...
NexoCode Go vam daje pristup ovim modelima za **$10/mjesečno**.

---

## Kako funkcioniše

NexoCode Go radi kao bilo koji drugi provajder u NexoCode-u.

1. Prijavite se na **<a href={console}>NexoCode Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `NexoCode Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na NexoCode Go.
:::
...
NexoCode Go je osmišljen za [NexoCode](https://nexocode.ai) i druge agente za programiranje
...
3. Slati stabilan ID sesije u zaglavlju `x-nexocode-session` za svaki razgovor kako bismo mogli optimizovati usmjeravanje i
   keširanje promptova.

### Provjereni klijenti

Pored NexoCode-a, potvrđeno je da sljedeći klijenti ispravno rade
s NexoCode Go. Ipak, ne garantiramo da će nastaviti raditi i u budućnosti.

| Klijent           | Podrška za sesije                                                                                                                                                                                                                                          |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Buildovi koji sadrže [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) šalju zaglavlje u glavnim i pomoćnim NexoCode zahtjevima. Ispravka je spojena nakon verzije v0.21.0; samo to izdanje je ne sadrži.                             |
...
| **ZCode**         | Go prepoznaje njegovo izvorno zaglavlje sesije. Naš [zahtjev za `x-nexocode-session`](https://github.com/zai-org/feedback/issues/492) i dalje je otvoren, ali slanje tog konkretnog zaglavlja više nije potrebno.                                          |
| **Pi**            | Trenutni buildovi šalju informacije o sesiji za NexoCode. Ažurirajte starije instalacije.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Buildovi koji sadrže [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) vraćaju NexoCode zaglavlja sesije. Ova ispravka obuhvata CLI, ali ne i VS Code ekstenziju. Pogledajte [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
[Model id](/docs/config/#models) u vašoj NexoCode konfiguraciji
koristi format `nexocode-go/<model-id>`. Na primjer, za Kimi K3, koristili biste
`nexocode-go/kimi-k3` u svojoj konfiguraciji.
...
Napravili smo NexoCode Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz NexoCode koristite i bilo kojeg drugog provajdera.

---
title: TUI
description: Korištenje korisničkog interfejsa NexoCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NexoCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje NexoCode pokreće TUI za trenutni direktorij.
...
Kada koristite NexoCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u NexoCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz NexoCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `nexocode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo NexoCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `nexocode.default`.

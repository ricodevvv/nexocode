...
Kreiraj `.nexocode/commands/test.md`:
...
Možete dodati prilagođene komande kroz NexoCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom NexoCode [config](/docs/config):
...
- Globalno: `~/.config/nexocode/commands/`
- Po projektu: `.nexocode/commands/`
...
NexoCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note

...
สร้าง `.nexocode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ NexoCode:
...
- ระดับผู้ใช้ (Global): `~/.config/nexocode/commands/`
- ระดับโปรเจ็กต์: `.nexocode/commands/`
...
NexoCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)

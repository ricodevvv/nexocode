...
import { IconNexocode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "nexocode/session/message-v2"
import type { Message } from "nexocode/session/message"
import type { Session } from "nexocode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.nexocode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.nexocode_name}>
                    <IconNexocode width={16} height={16} />
                  </div>

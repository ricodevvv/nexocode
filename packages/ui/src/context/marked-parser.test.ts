...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[NexoCode](https://nexocode.ai)")).toBe(
    '<p><a href="https://nexocode.ai" class="external-link" target="_blank" rel="noopener noreferrer">NexoCode</a></p>\n',
  )
})

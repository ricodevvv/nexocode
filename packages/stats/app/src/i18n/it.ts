export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | NexoCode Data",
  "app.description":
    "Esplora l'utilizzo di NexoCode nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo NexoCode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a NexoCode su GitHub",
  "header.github": "GitHub",
  "header.tryNexoCode": "Prova NexoCode",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in NexoCode.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di NexoCode per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | NexoCode Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in NexoCode, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di NexoCode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in NexoCode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di NexoCode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token NexoCode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | NexoCode Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in NexoCode, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di NexoCode appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo NexoCode della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo NexoCode della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di NexoCode nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di NexoCode, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di NexoCode.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token NexoCode nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di NexoCode nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione NexoCode.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica NexoCode corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token NexoCode.",

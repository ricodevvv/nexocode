export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | NexoCode Data",
  "app.description":
    "NexoCode kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde NexoCode Data logosu",
  ...
  "header.githubAria": "GitHub'da NexoCode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryNexoCode": "NexoCode'u dene",
  ...
  "footer.homeAria": "NexoCode ana sayfası",
  ...
  "home.topModelsDescription": "NexoCode genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz NexoCode kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | NexoCode Data",
  "lab.description":
    "NexoCode'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son NexoCode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "NexoCode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son NexoCode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük NexoCode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | NexoCode Data",
  "model.description":
    "{{model}} için NexoCode kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda NexoCode kullanımı görünür.",
  "model.unranked": "Geçen haftaki NexoCode kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki NexoCode kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde NexoCode kullanımı yok.",
  ...
  "model.overviewDescription": "Son NexoCode tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz NexoCode kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük NexoCode token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz NexoCode kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama NexoCode oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen NexoCode coğrafi satırı yok.",
  "model.peersDescription": "Son NexoCode token hacmine göre yakındaki modeller.",

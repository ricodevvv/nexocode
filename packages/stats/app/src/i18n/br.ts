export const dict = {
  "app.title": "Ranking de uso de modelos de IA | NexoCode Data",
  "app.description":
    "Explore o uso do NexoCode em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do NexoCode Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao NexoCode no GitHub",
  "header.github": "GitHub",
  "header.tryNexoCode": "Experimente o NexoCode",
  ...
  "footer.homeAria": "Início do NexoCode",
  ...
  "modal.title": "Newsletter do NexoCode",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no NexoCode.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do NexoCode por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | NexoCode Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no NexoCode, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do NexoCode.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no NexoCode",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do NexoCode",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do NexoCode nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | NexoCode Data",
  "model.description":
    "Veja dados de uso de {{model}} no NexoCode, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no NexoCode aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do NexoCode da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do NexoCode da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do NexoCode na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do NexoCode, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do NexoCode.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do NexoCode na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do NexoCode na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do NexoCode.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do NexoCode correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do NexoCode.",

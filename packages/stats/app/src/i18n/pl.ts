export const dict = {
  "app.title": "Rankingi użycia modeli AI | NexoCode Data",
  "app.description":
    "Przeglądaj użycie NexoCode w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny NexoCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę NexoCode na GitHub",
  "header.github": "GitHub",
  "header.tryNexoCode": "Wypróbuj NexoCode",
  ...
  "footer.homeAria": "Strona główna NexoCode",
  ...
  "home.topModelsDescription": "Użycie modeli w NexoCode.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy NexoCode według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | NexoCode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w NexoCode, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia NexoCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w NexoCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia NexoCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów NexoCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | NexoCode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w NexoCode, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie NexoCode pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu NexoCode z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu NexoCode z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia NexoCode w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny NexoCode, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia NexoCode.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów NexoCode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy NexoCode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji NexoCode.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne NexoCode nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów NexoCode.",

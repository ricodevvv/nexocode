export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | NexoCode Data",
  "app.description":
    "Explorez l'utilisation d'NexoCode par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel NexoCode Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à NexoCode sur GitHub",
  "header.github": "GitHub",
  "header.tryNexoCode": "Essayer NexoCode",
  ...
  "footer.homeAria": "Accueil NexoCode",
  ...
  "modal.title": "Newsletter NexoCode",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans NexoCode.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'NexoCode par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | NexoCode Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans NexoCode, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'NexoCode.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans NexoCode",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'NexoCode",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens NexoCode sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | NexoCode Data",
  "model.description":
    "Consultez les données d'utilisation NexoCode de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation NexoCode apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation NexoCode de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation NexoCode de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation NexoCode dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens NexoCode récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation NexoCode.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens NexoCode sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'NexoCode sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions NexoCode.",
  ...
  "model.noGeoDescription": "Aucune ligne géographique NexoCode ne correspondait à ce modèle.",
  "model.peersDescription": "Modèles proches par volume récent de tokens NexoCode.",

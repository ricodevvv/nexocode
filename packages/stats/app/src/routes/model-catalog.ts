...
export const modelCatalogSourceUrl = "https://models.nexocode.ai/catalog.json"
export const modelCatalogPricingUrl = "https://models.nexocode.ai/api.json"
export const modelCatalogLabSourceUrl = "https://models.nexocode.ai/labs"

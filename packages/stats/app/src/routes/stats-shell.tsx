import nexocodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/ricodevvv/nexocode",
  fallbackStars: "208K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "nexocode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://nexocode.ai/">
            <strong>{i18n.t("header.tryNexoCode")}</strong>
          </a>
          <button
...
function NexoCodeMark() {
  return (
    <svg data-slot="nexocode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://nexocode.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://nexocode.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@nexocode.ai", label: i18n.t("footer.contact") },
    { href: "https://nexocode.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/nexocode", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://nexocode.ai" aria-label={i18n.t("footer.homeAria")}>
          <NexoCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={nexocodeWordmarkDark} alt="NexoCode" />
          <button

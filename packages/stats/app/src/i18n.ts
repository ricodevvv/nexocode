...
const en = {
  "app.title": "AI Model Usage Rankings | NexoCode Data",
  "app.description":
    "Explore NexoCode usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "NexoCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star NexoCode on GitHub",
  "header.github": "GitHub",
  "header.tryNexoCode": "Try NexoCode",
  ...
  "home.topModelsDescription": "Usage of models across NexoCode.",
  ...
  "home.uniqueUsersDescription": "Daily unique NexoCode users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | NexoCode Data",
  "lab.description":
    "Compare {{lab}} models used in NexoCode, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent NexoCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in NexoCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent NexoCode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | NexoCode Data",
  "model.description":
    "View {{model}} NexoCode usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. NexoCode usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's NexoCode usage",
  "model.ranked": "Ranked #{{rank}} across last week's NexoCode usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No NexoCode usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no NexoCode usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No NexoCode geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent NexoCode token volume.",

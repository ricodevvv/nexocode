...
> current private `@nexocode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@nexocode-ai/ai`
...
- Secondary audience: NexoCode and other durable agent runtimes
...
import { LLM } from "@nexocode-ai/ai"
import { OpenAI } from "@nexocode-ai/ai/providers/openai"
...
```ts
import { Message } from "@nexocode-ai/ai"
...
import { LLM, Tool } from "@nexocode-ai/ai"
...
NexoCode and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@nexocode-ai/ai/promise"
import { OpenAI } from "@nexocode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@nexocode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@nexocode-ai/ai/provider"
...
@nexocode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@nexocode-ai/ai/schema
  serializable domain schemas

@nexocode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@nexocode-ai/ai/providers/openai
@nexocode-ai/ai/providers/anthropic
@nexocode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@nexocode-ai/llm`                      | `@nexocode-ai/ai`                                           |
...
NexoCode should migrate to `generateTurn` / `streamTurn`, preserving its durable

...
Schema-first LLM core for nexocode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@nexocode-ai/llm"
import { OpenAI } from "@nexocode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@nexocode-ai/llm/providers"

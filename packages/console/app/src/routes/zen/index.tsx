...
import compareVideo from "../../asset/lander/nexocode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/nexocode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="nexocode:auth" content={loggedin() ? "true" : "false"} />

import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@nexocode-ai/sdk/v2"
import { SessionTurn } from "@nexocode-ai/session-ui/session-turn"
import { SessionReview } from "@nexocode-ai/session-ui/session-review"
import { DataProvider } from "@nexocode-ai/session-ui/context"
import { FileComponentProvider } from "@nexocode-ai/ui/context/file"
import { WorkerPoolProvider } from "@nexocode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@nexocode-ai/ui/logo"
import { IconButton } from "@nexocode-ai/ui/icon-button"
import { ProviderIcon } from "@nexocode-ai/ui/provider-icon"
import { iife } from "@nexocode-ai/core/util/iife"
import { Binary } from "@nexocode-ai/core/util/binary"
import { NamedError } from "@nexocode-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@nexocode-ai/ui/tabs"
import { MessageNav } from "@nexocode-ai/session-ui/message-nav"
import { FileSSR } from "@nexocode-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@nexocode-ai/session-ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | NexoCode</Title>
              </Show>
              <Meta name="description" content="nexocode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/ricodevvv/nexocode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://nexocode.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />

...
export const TypeId: TypeId = "~@nexocode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@nexocode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@nexocode-ai/effect-sqlite-node/NodeSqliteClient")

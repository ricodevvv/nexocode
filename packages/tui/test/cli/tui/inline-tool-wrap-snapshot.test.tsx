...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "NEXOCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/nexocode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/nexocode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/nexocode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/nexocode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const NEXOCODE_DB|NEXOCODE_DB|NEXOCODE_DEV|Global\\.Path\\.data|data =" in packages/nexocode/src (115 matches)',
  },
] as const

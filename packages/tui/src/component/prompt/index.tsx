...
import { registerNexocodeSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@nexocode-ai/sdk/v2"
...
import { NEXOCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useNexocodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.NEXOCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
  ...
  return (
    <>
      <box ref={(r: BoxRenderable) => (anchor = r)} visible={props.visible !== false} width="100%">
        ...
        <box width="100%" flexDirection="row" justifyContent="space-between" alignItems="flex-end">
          <Switch>
            <Match when={status().type !== "idle"}>
              ...
              >
                <box flexShrink={0} flexDirection="row" gap={1} alignItems="flex-end">
                  <box marginLeft={1}>
                    <Axo mode="laptop" />
                  </box>

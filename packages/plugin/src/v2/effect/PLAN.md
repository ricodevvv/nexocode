...
- Effect plugins import `@nexocode-ai/plugin/v2/effect`, not `@nexocode-ai/core`.
- Public domain values use generated `@nexocode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@nexocode-ai/plugin/v2/effect`.

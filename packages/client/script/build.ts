...
import { compile, emitEffectImported, emitPromise, write } from "@nexocode-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "NexoCodeEventEncoded",
              import: 'import type { NexoCodeEventEncoded } from "@nexocode-ai/protocol/groups/event"',
            },
          },
        }),

import type { NexoCodeEvent } from "@nexocode-ai/client/promise"
import type { Event } from "@nexocode-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: NexoCodeEvent }
...
export function adaptServerEvent(event: NexoCodeEvent): ServerEvent {
...
function currentDelta(event: NexoCodeEvent | undefined): CurrentDelta | undefined {
  if (

import type { NexoCodeEvent, SessionMessageInfo, SessionPendingMessage } from "@nexocode-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: NexoCodeEvent): V2SessionReduction | undefined => {

  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://nexocode.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://nexocode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://nexocode.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://nexocode.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://nexocode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://nexocode.example.com"),
      ),
    ).toEqual({

import type { SessionApi } from "@nexocode-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { NexocodeClient } from "@nexocode-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: NexocodeClient; directory: string; limit: number }) {
  try {

...
import type { Agent, PermissionRequest, Project, Provider, ProviderListResponse } from "@nexocode-ai/sdk/v2/client"
import type { Project as CurrentProject } from "@nexocode-ai/client/promise"

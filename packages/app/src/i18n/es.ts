export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de NexoCode",
  ...
  "desktop.menu.ariaLabel": "Menú de NexoCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar NexoCode",
  "desktop.recovery.terminated": "La ventana de NexoCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "NexoCode no responde",
  ...
  "desktop.wsl.error.installNexocode": "No se pudo instalar NexoCode",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.nexocodeMissing": "nexocode no está instalado en esta distribución",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de NexoCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.nexocode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.nexocodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.nexocodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NexoCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en nexocode.json",
  ...
  "dialog.server.description": "Cambiar el servidor de NexoCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingNexocode": "Comprobando NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Comprobando NexoCode en {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Actualizando NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Actualizando NexoCode en {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Actualiza NexoCode en {{distro}}.",
  "wsl.onboarding.updateNexocode": "Actualizar NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode está listo en {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode está listo.",
  "wsl.onboarding.installNexocodeIn": "Instala NexoCode en {{distro}}.",
  "wsl.onboarding.installNexocode": "Instalar NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que NexoCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NexoCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de NexoCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de NexoCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (nexocode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: NexoCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor NexoCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para NexoCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve NexoCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si NexoCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de NexoCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NexoCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de NexoCode.",

export const dict = {
  ...
  "desktop.recovery.loadFailed": "NexoCodeを読み込めませんでした",
  "desktop.recovery.terminated": "NexoCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "NexoCodeが応答していません",
  ...
  "desktop.wsl.error.installNexocode": "NexoCodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.nexocodeMissing": "このディストリビューションにはnexocodeがインストールされていません",
  "desktop.wsl.error.nexocodeCannotRun": "nexocodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.nexocodeNotInstalled": "{{distro}}にはNexoCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "NexoCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.nexocode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.nexocode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.nexocodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、NexoCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.nexocodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.nexocodeZen.visit.prefix": " ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNexoCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、NexoCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "nexocode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するNexoCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCodeを確認中...",
  "wsl.onboarding.checkingNexocodeIn": "{{distro}}内のNexoCodeを確認中...",
  "wsl.onboarding.updatingNexocode": "NexoCodeを更新中...",
  "wsl.onboarding.updatingNexocodeIn": "{{distro}}内のNexoCodeを更新中...",
  "wsl.onboarding.updateNexocodeIn": "{{distro}}内のNexoCodeを更新してください。",
  "wsl.onboarding.updateNexocode": "NexoCodeを更新",
  "wsl.onboarding.nexocodeReadyIn": "{{distro}}内のNexoCodeの準備ができました。",
  "wsl.onboarding.nexocodeReady": "NexoCodeの準備ができました。",
  "wsl.onboarding.installNexocodeIn": "{{distro}}にNexoCodeをインストールしてください。",
  "wsl.onboarding.installNexocode": "NexoCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NexoCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、NexoCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "NexoCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NexoCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNexoCodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (nexocode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NexoCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "NexoCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNexoCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "NexoCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNexoCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "NexoCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "NexoCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "NexoCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "NexoCode は最新バージョンです。",

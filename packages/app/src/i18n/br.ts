export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do NexoCode",
  ...
  "desktop.menu.ariaLabel": "Menu do NexoCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o NexoCode",
  "desktop.recovery.terminated": "A janela do NexoCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O NexoCode não está respondendo",
  ...
  "desktop.wsl.error.installNexocode": "Falha na instalação do NexoCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.nexocodeMissing": "O nexocode não está instalado nesta distribuição",
  "desktop.wsl.error.nexocodeCannotRun": "O nexocode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.nexocodeNotInstalled": "O NexoCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do NexoCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.nexocode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.nexocodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Visite ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no NexoCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em nexocode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor NexoCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingNexocode": "Verificando o NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Verificando o NexoCode em {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Atualizando o NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Atualizando o NexoCode em {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Atualize o NexoCode em {{distro}}.",
  "wsl.onboarding.updateNexocode": "Atualizar o NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "O NexoCode está pronto em {{distro}}.",
  "wsl.onboarding.nexocodeReady": "O NexoCode está pronto.",
  "wsl.onboarding.installNexocodeIn": "Instale o NexoCode em {{distro}}.",
  "wsl.onboarding.installNexocode": "Instalar o NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o NexoCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O NexoCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o NexoCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o NexoCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do NexoCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do NexoCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (nexocode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: NexoCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor NexoCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do NexoCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o NexoCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o NexoCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o NexoCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o NexoCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do NexoCode.",

export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú NexoCode.",
  ...
  "desktop.recovery.loadFailed": "NexoCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra NexoCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "NexoCode no respon",
  ...
  "desktop.wsl.error.installNexocode": "La instal·lació de NexoCode ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.nexocodeMissing": "nexocode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NexoCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.nexocode.tagline": "Models optimitzats fiables",
  "dialog.provider.nexocodeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.nexocodeZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a NexoCode.",
  ...
  "dialog.plugins.empty": "Connectors configurats a nexocode.json",
  ...
  "dialog.server.description": "Canvia a quin NexoCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingNexocode": "S'està comprovant NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "S'està registrant NexoCode a {{distro}}...",
  "wsl.onboarding.updatingNexocode": "S'està actualitzant NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "S'està actualitzant NexoCode a {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Actualitza NexoCode a {{distro}}.",
  "wsl.onboarding.updateNexocode": "Actualització NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode està llest a {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode està llest.",
  "wsl.onboarding.installNexocodeIn": "Instal·leu NexoCode a {{distro}}.",
  "wsl.onboarding.installNexocode": "Instal·la NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que NexoCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NexoCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de NexoCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip NexoCode.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (nexocode.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que NexoCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "NexoCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor NexoCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a NexoCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu NexoCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si NexoCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de NexoCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï NexoCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de NexoCode.",

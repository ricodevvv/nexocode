export const dict = {
  ...
  "dialog.provider.nexocode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.nexocode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.nexocodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.nexocodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.nexocodeZen.visit.prefix": "Besøg ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i NexoCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i nexocode.json",
  ...
  "dialog.server.description": "Skift hvilken NexoCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingNexocode": "Tjekker NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Tjekker NexoCode i {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Opdaterer NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Opdaterer NexoCode i {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Opdater NexoCode i {{distro}}.",
  "wsl.onboarding.updateNexocode": "Opdater NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før NexoCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "NexoCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter NexoCode igen.",
  ...
  "toast.update.description": "En ny version af NexoCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NexoCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (nexocode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NexoCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør NexoCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NexoCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan NexoCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om NexoCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas NexoCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NexoCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NexoCode.",
  ...
  "desktop.recovery.loadFailed": "NexoCode kunne ikke indlæses",
  "desktop.recovery.terminated": "NexoCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installNexocode": "Installationen af NexoCode mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.nexocodeMissing": "nexocode er ikke installeret i denne distribution",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode er installeret, men kunne ikke køre",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af NexoCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "NexoCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":

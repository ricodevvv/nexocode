export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu NexoCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được NexoCode",
  "desktop.recovery.terminated": "Cửa sổ NexoCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "NexoCode không phản hồi",
  ...
  "desktop.wsl.error.installNexocode": "Không cài đặt được NexoCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.nexocodeMissing": "nexocode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật NexoCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.nexocode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.nexocodeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do NexoCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Truy cập ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong NexoCode.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong nexocode.json",
  ...
  "dialog.server.description": "Chuyển máy chủ NexoCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingNexocode": "Đang kiểm tra NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Đang kiểm tra NexoCode trong {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Đang cập nhật NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Đang cập nhật NexoCode trong {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Cập nhật NexoCode trong {{distro}}.",
  "wsl.onboarding.updateNexocode": "Cập nhật NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode đã sẵn sàng.",
  "wsl.onboarding.installNexocodeIn": "Cài đặt NexoCode trong {{distro}}.",
  "wsl.onboarding.installNexocode": "Cài đặt NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi NexoCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "NexoCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của NexoCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm NexoCode",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (nexocode.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: NexoCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ NexoCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho NexoCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của NexoCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem NexoCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của NexoCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi NexoCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của NexoCode.",

...
export const dict = {
  ...
  "dialog.provider.nexocode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.nexocode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.nexocodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NexoCode zu nutzen.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in NexoCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NexoCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In nexocode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den NexoCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode wird geprüft…",
  "wsl.onboarding.checkingNexocodeIn": "NexoCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingNexocode": "NexoCode wird aktualisiert…",
  "wsl.onboarding.updatingNexocodeIn": "NexoCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateNexocodeIn": "Aktualisieren Sie NexoCode in {{distro}}.",
  "wsl.onboarding.updateNexocode": "NexoCode aktualisieren",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode ist in {{distro}} bereit.",
  "wsl.onboarding.nexocodeReady": "NexoCode ist bereit.",
  "wsl.onboarding.installNexocodeIn": "Installieren Sie NexoCode in {{distro}}.",
  "wsl.onboarding.installNexocode": "NexoCode installieren",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor NexoCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "NexoCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann NexoCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von NexoCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem NexoCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (nexocode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: NexoCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "NexoCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "NexoCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "NexoCode Desktop",
  ...
  "settings.desktop.wsl.description": "NexoCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für NexoCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie NexoCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob NexoCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von NexoCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von NexoCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "NexoCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von NexoCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "NexoCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das NexoCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "NexoCode reagiert nicht",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.nexocodeMissing": "nexocode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das NexoCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "NexoCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":

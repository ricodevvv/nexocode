export const dict = {
  ...
  "desktop.menu.documentation": "Documentație NexoCode",
  ...
  "desktop.menu.ariaLabel": "Meniu NexoCode",
  ...
  "desktop.recovery.loadFailed": "NexoCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra NexoCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "NexoCode nu răspunde",
  ...
  "desktop.wsl.error.installNexocode": "Instalarea NexoCode a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.nexocodeMissing": "nexocode nu este instalat în această distribuție",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea NexoCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.nexocode.tagline": "Modele optimizate, fiabile",
  "dialog.provider.nexocodeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.nexocodeZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.nexocodeZen.visit.prefix": "Vizitează",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în NexoCode.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în nexocode.json",
  ...
  "dialog.server.description": "Schimbă serverul NexoCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingNexocode": "Se verifică NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Se verifică NexoCode în {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Se actualizează NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Se actualizează NexoCode în {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Actualizează NexoCode în {{distro}}.",
  "wsl.onboarding.updateNexocode": "Actualizează NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode este gata în {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode este gata.",
  "wsl.onboarding.installNexocodeIn": "Instalează NexoCode în {{distro}}.",
  "wsl.onboarding.installNexocode": "Instalează NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca NexoCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "NexoCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune NexoCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei NexoCode",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (nexocode.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, NexoCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul NexoCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru NexoCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul NexoCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă NexoCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema NexoCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea NexoCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune NexoCode.",

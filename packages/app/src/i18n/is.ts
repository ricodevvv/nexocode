...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða NexoCode",
  "NexoCode-glugganum var óvænt lokað",
  "NexoCode svarar ekki",
  ...
  "Uppsetning NexoCode mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "nexocode er ekki uppsett í þessari dreifingu",
  "nexocode er uppsett en ekki var hægt að keyra það",
  "NexoCode er ekki uppsett í {{distro}}",
  "Uppfærslu NexoCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.nexocode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.nexocode.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.nexocodeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.nexocodeZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.nexocodeZen.visit.prefix": "Heimsókn",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í NexoCode.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í nexocode.json",
  ...
  "dialog.server.description": "Skiptu um hvaða NexoCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingNexocode": "Athugar NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Athugar NexoCode í {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Uppfærir NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Uppfærir NexoCode í {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Uppfærðu NexoCode í {{distro}}.",
  "wsl.onboarding.updateNexocode": "Uppfærðu NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode er tilbúið í {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode er tilbúinn.",
  "wsl.onboarding.installNexocodeIn": "Settu upp NexoCode í {{distro}}.",
  "wsl.onboarding.installNexocode": "Settu upp NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en NexoCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "NexoCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan NexoCode aftur.",
  ...
  "help.tabs.introduction": "NexoCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af NexoCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til NexoCode teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (nexocode.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, NexoCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "NexoCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "NexoCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu NexoCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir NexoCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig NexoCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort NexoCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig NexoCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar NexoCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af NexoCode.",

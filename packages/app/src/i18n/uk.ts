export const dict = {
  ...
  "desktop.menu.documentation": "Документація NexoCode",
  ...
  "desktop.menu.ariaLabel": "Меню NexoCode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити NexoCode",
  "desktop.recovery.terminated": "Роботу вікна NexoCode несподівано завершено",
  "desktop.recovery.unresponsive": "NexoCode не відповідає",
  ...
  "desktop.wsl.error.installNexocode": "Не вдалося встановити NexoCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.nexocodeMissing": "nexocode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення NexoCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.nexocode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.nexocodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у NexoCode.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в nexocode.json",
  ...
  "dialog.server.description": "Перемкніть сервер NexoCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingNexocode": "Перевірка NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Перевірка NexoCode у {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Оновлення NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Оновлення NexoCode у {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Оновіть NexoCode у {{distro}}.",
  "wsl.onboarding.updateNexocode": "Оновити NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode готовий до роботи.",
  "wsl.onboarding.installNexocodeIn": "Встановіть NexoCode у {{distro}}.",
  "wsl.onboarding.installNexocode": "Встановити NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в NexoCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "NexoCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія NexoCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді NexoCode",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (nexocode.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, NexoCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер NexoCode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу NexoCode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд NexoCode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи NexoCode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему NexoCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску NexoCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію NexoCode.",

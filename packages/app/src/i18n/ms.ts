export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi NexoCode",
  ...
  "desktop.recovery.loadFailed": "NexoCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap NexoCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "NexoCode tidak memberi respons",
  ...
  "desktop.wsl.error.installNexocode": "Pemasangan NexoCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.nexocodeMissing": "nexocode tidak dipasang dalam distro ini",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini NexoCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.nexocode.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.nexocodeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Layari",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam NexoCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam nexocode.json",
  ...
  "dialog.server.description": "Tukar pelayan NexoCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingNexocode": "Sedang menyemak NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Sedang menyemak NexoCode dalam {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Sedang mengemas kini NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Sedang mengemas kini NexoCode dalam {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Kemas kini NexoCode dalam {{distro}}.",
  "wsl.onboarding.updateNexocode": "Kemas kini NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode sedia digunakan.",
  "wsl.onboarding.installNexocodeIn": "Pasang NexoCode dalam {{distro}}.",
  "wsl.onboarding.installNexocode": "Pasang NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NexoCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NexoCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu NexoCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan NexoCode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (nexocode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, NexoCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan NexoCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk NexoCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa NexoCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada NexoCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema NexoCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila NexoCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini NexoCode.",

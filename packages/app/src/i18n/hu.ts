...
const desktop = [
  ...
  "Kilépés",
  "Az NexoCode betöltése sikertelen",
  "Az NexoCode ablaka váratlanul leállt",
  "Az NexoCode nem válaszol",
  ...
  "Az NexoCode telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az nexocode nincs telepítve ebben a disztribúcióban",
  "Az nexocode telepítve van, de nem futtatható",
  "Az NexoCode nincs telepítve ebben: {{distro}}",
  "Az NexoCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.nexocode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.nexocode.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.nexocodeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A NexoCode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a NexoCode-ben.",
  ...
  "provider.connect.nexocodeZen.line1":
    "A NexoCode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Látogatás",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a NexoCode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a NexoCode-ben.",
  ...
  "dialog.plugins.empty": "Az nexocode.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik NexoCode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode ellenőrzése...",
  "wsl.onboarding.checkingNexocodeIn": "NexoCode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingNexocode": "NexoCode frissítése...",
  "wsl.onboarding.updatingNexocodeIn": "NexoCode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateNexocodeIn": "Frissítse a NexoCode-t a {{distro}}-ben.",
  "wsl.onboarding.updateNexocode": "Frissítse a NexoCode-t",
  "wsl.onboarding.nexocodeReadyIn": "A NexoCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.nexocodeReady": "A NexoCode készen áll.",
  "wsl.onboarding.installNexocodeIn": "Telepítse a NexoCode-t a {{distro}}-be.",
  "wsl.onboarding.installNexocode": "Telepítse a NexoCode-t",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "A NexoCode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a NexoCode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A NexoCode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a NexoCode programot.",
  ...
  "help.tabs.introduction": "A NexoCode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A NexoCode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a NexoCode csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (nexocode.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a NexoCode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A NexoCode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "NexoCode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a NexoCode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a NexoCode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a NexoCode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a NexoCode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a NexoCode témáját.",
  ...
  "settings.updates.row.startup.description": "A NexoCode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a NexoCode legújabb verzióját futtatja.",

export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "NexoCode menyusi",
  ...
  "desktop.recovery.loadFailed": "NexoCode yuklanmadi",
  "desktop.recovery.terminated": "NexoCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "NexoCode javob bermayapti",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.nexocodeMissing": "Nexocode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "NexoCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.nexocode.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.nexocodeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va NexoCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va NexoCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va NexoCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "nexocode.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi NexoCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode tekshirilmoqda...",
  "wsl.onboarding.checkingNexocodeIn": "NexoCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingNexocode": "NexoCode yangilanmoqda...",
  "wsl.onboarding.updatingNexocodeIn": "NexoCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateNexocodeIn": "NexoCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateNexocode": "NexoCode-ni yangilang",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode {{distro}} da tayyor.",
  "wsl.onboarding.nexocodeReady": "NexoCode tayyor.",
  "wsl.onboarding.installNexocodeIn": "NexoCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installNexocode": "NexoCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NexoCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "NexoCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra NexoCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "NexoCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NexoCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida NexoCode jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (nexocode.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, NexoCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "NexoCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi NexoCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "NexoCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "NexoCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "NexoCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "NexoCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "NexoCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz NexoCode oxirgi versiyasini ishga tushiryapsiz.",

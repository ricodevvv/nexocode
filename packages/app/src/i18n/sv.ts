export const dict = {
  ...
  "desktop.recovery.loadFailed": "NexoCode kunde inte läsas in",
  "desktop.recovery.terminated": "NexoCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "NexoCode svarar inte",
  ...
  "desktop.wsl.error.installNexocode": "Installationen av NexoCode misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.nexocodeMissing": "nexocode är inte installerat i den här distributionen",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode är installerat men kunde inte köras",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NexoCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.nexocode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.nexocode.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.nexocodeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.nexocodeZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.nexocodeZen.visit.prefix": "Besök ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i NexoCode.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i nexocode.json",
  ...
  "dialog.server.description": "Växla vilken NexoCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingNexocode": "Kontrollerar NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Kontrollerar NexoCode i {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Uppdaterar NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Uppdaterar NexoCode i {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Uppdatera NexoCode i {{distro}}.",
  "wsl.onboarding.updateNexocode": "Uppdatera NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode är redo i {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode är redo.",
  "wsl.onboarding.installNexocodeIn": "Installera NexoCode i {{distro}}.",
  "wsl.onboarding.installNexocode": "Installera NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan NexoCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "NexoCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan NexoCode igen.",
  ...
  "help.tabs.introduction": "NexoCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av NexoCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till NexoCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (nexocode.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, NexoCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör NexoCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för NexoCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur NexoCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om NexoCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa NexoCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när NexoCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av NexoCode.",

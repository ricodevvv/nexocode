export const dict = {
  ...
  "dialog.provider.nexocode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.nexocode.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.nexocodeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NexoCodessa.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Avaa ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja NexoCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NexoCodessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään nexocode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda NexoCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingNexocode": "Tarkistetaan NexoCodea...",
  "wsl.onboarding.checkingNexocodeIn": "Tarkistetaan NexoCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Päivitetään NexoCodea...",
  "wsl.onboarding.updatingNexocodeIn": "Päivitetään NexoCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Päivitä NexoCode jakelussa {{distro}}.",
  "wsl.onboarding.updateNexocode": "Päivitä NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode on valmis.",
  "wsl.onboarding.installNexocodeIn": "Asenna NexoCode jakeluun {{distro}}.",
  "wsl.onboarding.installNexocode": "Asenna NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin NexoCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "NexoCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten NexoCode uudelleen.",
  ...
  "toast.update.description": "NexoCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä NexoCode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (nexocode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että NexoCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita NexoCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda NexoCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä NexoCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö NexoCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta NexoCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun NexoCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät NexoCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "NexoCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "NexoCode-valikko",
  ...
  "desktop.recovery.loadFailed": "NexoCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "NexoCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "NexoCode ei vastaa",
  ...
  "desktop.wsl.error.installNexocode": "NexoCoden asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.nexocodeMissing": "nexocodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NexoCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "NexoCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":

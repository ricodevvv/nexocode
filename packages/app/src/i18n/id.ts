export const dict = {
  ...
  "desktop.recovery.loadFailed": "NexoCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela NexoCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "NexoCode tidak merespons",
  ...
  "desktop.wsl.error.installNexocode": "Instalasi NexoCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.nexocodeMissing": "nexocode belum terinstal di distro ini",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan NexoCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.nexocode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.nexocodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di NexoCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di nexocode.json",
  ...
  "dialog.server.description": "Ganti server NexoCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingNexocode": "Memeriksa NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Memeriksa NexoCode di {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Memperbarui NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Memperbarui NexoCode di {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Perbarui NexoCode di {{distro}}.",
  "wsl.onboarding.updateNexocode": "Perbarui NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode siap di {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode siap.",
  "wsl.onboarding.installNexocodeIn": "Instal NexoCode di {{distro}}.",
  "wsl.onboarding.installNexocode": "Instal NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NexoCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NexoCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru NexoCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim NexoCode",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (nexocode.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: NexoCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server NexoCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk NexoCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan NexoCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah NexoCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat NexoCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru NexoCode.",

export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka NexoCode",
  ...
  "desktop.recovery.loadFailed": "NexoCode se nepodařilo načíst",
  "desktop.recovery.terminated": "NexoCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "NexoCode nereaguje",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.nexocodeMissing": "nexocode není v této distribuci nainstalováno",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NexoCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.nexocode.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.nexocodeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Návštěva ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v NexoCode.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v nexocode.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému NexoCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingNexocode": "Kontrola NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Kontrola NexoCode v {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Aktualizace NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Aktualizace NexoCode v {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Aktualizace NexoCode v {{distro}}.",
  "wsl.onboarding.updateNexocode": "Aktualizovat NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode je připraveno v {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode je připraven.",
  "wsl.onboarding.installNexocodeIn": "Nainstalujte NexoCode do {{distro}}.",
  "wsl.onboarding.installNexocode": "Instalovat NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než NexoCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "NexoCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze NexoCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu NexoCode",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (nexocode.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: NexoCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server NexoCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro NexoCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled NexoCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude NexoCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma NexoCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění NexoCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi NexoCode.",

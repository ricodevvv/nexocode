export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni NexoCode",
  ...
  "desktop.menu.ariaLabel": "Menuja NexoCode",
  ...
  "desktop.recovery.loadFailed": "NexoCode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja NexoCode u mbyll papritur",
  "desktop.recovery.unresponsive": "NexoCode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installNexocode": "Instalimi i NexoCode dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.nexocodeMissing": "Nexocode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.nexocodeCannotRun": "Nexocode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i NexoCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.nexocode.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.nexocodeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në NexoCode.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në nexocode.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server NexoCode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingNexocode": "Po kontrollon NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Po kontrollon NexoCode në {{distro}}...",
  "wsl.onboarding.updatingNexocode": "NexoCode po përditësohet...",
  "wsl.onboarding.updatingNexocodeIn": "Po përditëson NexoCode në {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Përditëso NexoCode në {{distro}}.",
  "wsl.onboarding.updateNexocode": "Përditëso NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode është gati në {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode është gati.",
  "wsl.onboarding.installNexocodeIn": "Instaloni NexoCode në {{distro}}.",
  "wsl.onboarding.installNexocode": "Instaloni NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se NexoCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "NexoCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i NexoCode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i NexoCode",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (nexocode.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, NexoCode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin NexoCode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për NexoCode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket NexoCode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse NexoCode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e NexoCode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset NexoCode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të NexoCode.",

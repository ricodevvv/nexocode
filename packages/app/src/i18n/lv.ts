export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode dokumentācija",
  ...
  "desktop.menu.ariaLabel": "NexoCode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt NexoCode",
  "desktop.recovery.terminated": "NexoCode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "NexoCode neatbild",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.nexocodeMissing": "nexocode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NexoCode atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.nexocode.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.nexocodeGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus NexoCode.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti nexocode.json",
  ...
  "dialog.server.description": "Mainiet, pie kura NexoCode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingNexocode": "Pārbaudu NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Pārbaudu NexoCode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Atjauninu NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Atjauninu NexoCode distribūcijā {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Atjauniniet NexoCode distribūcijā {{distro}}.",
  "wsl.onboarding.updateNexocode": "Atjauniniet NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode ir gatavs.",
  "wsl.onboarding.installNexocodeIn": "Instalējiet NexoCode distribūcijā {{distro}}.",
  "wsl.onboarding.installNexocode": "Instalējiet NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms NexoCode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "NexoCode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet NexoCode no jauna.",
  ...
  "help.tabs.introduction": "NexoCode Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna NexoCode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu NexoCode komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (nexocode.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, NexoCode vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "NexoCode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist NexoCode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt NexoCode saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā NexoCode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai NexoCode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet NexoCode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot NexoCode",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko NexoCode versiju.",

...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "NexoCode failed to load",
  "desktop.recovery.terminated": "NexoCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "NexoCode is not responding",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.nexocodeMissing": "nexocode is not installed in this distro",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode is installed but could not run",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NexoCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",

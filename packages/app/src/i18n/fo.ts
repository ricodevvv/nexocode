export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode Skjøl",
  ...
  "desktop.menu.ariaLabel": "NexoCode valmynd",
  ...
  "desktop.recovery.loadFailed": "NexoCode miseydnaðist at heinta",
  "desktop.recovery.terminated": "NexoCode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "NexoCode svarar ikki",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.nexocodeMissing": "nexocode er ikki sett upp í hesi distro",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NexoCode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.nexocode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.nexocode.tagline": "Álítandi optimerað modell",
  "dialog.provider.nexocodeGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.nexocodeZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.nexocodeZen.visit.prefix": "Vitja ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í NexoCode.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í nexocode.json",
  ...
  "dialog.server.description": "Skift hvønn NexoCode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingNexocode": "Kanna NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Kanna NexoCode í {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Dagføring NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Dagføring NexoCode í {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Dagfør NexoCode í {{distro}}.",
  "wsl.onboarding.updateNexocode": "Dagfør NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode er klárt í {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode er klárt.",
  "wsl.onboarding.installNexocodeIn": "Set NexoCode upp í {{distro}}.",
  "wsl.onboarding.installNexocode": "Set upp NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn NexoCode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "NexoCode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani NexoCode aftur.",
  ...
  "help.tabs.introduction": "NexoCode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av NexoCode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til NexoCode toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (nexocode.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, NexoCode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "NexoCode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr NexoCode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri NexoCode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu NexoCode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um NexoCode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu NexoCode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá NexoCode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av NexoCode.",

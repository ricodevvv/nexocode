export const dict = {
  ...
  "desktop.recovery.loadFailed": "NexoCode yüklənə bilmədi",
  "desktop.recovery.terminated": "NexoCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "NexoCode cavab vermir",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.nexocodeMissing": "Bu distribütivdə nexocode quraşdırılmayıb",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "NexoCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.nexocode.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.nexocodeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və NexoCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və NexoCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və NexoCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər nexocode.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu NexoCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode yoxlanılır...",
  "wsl.onboarding.checkingNexocodeIn": "{{distro}}-də NexoCode yoxlanılır...",
  "wsl.onboarding.updatingNexocode": "NexoCode yenilənir...",
  "wsl.onboarding.updatingNexocodeIn": "{{distro}}-də NexoCode yenilənir...",
  "wsl.onboarding.updateNexocodeIn": "{{distro}}-də NexoCode-u yeniləyin.",
  "wsl.onboarding.updateNexocode": "NexoCode-u yeniləyin",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode {{distro}}-də hazırdır.",
  "wsl.onboarding.nexocodeReady": "NexoCode hazırdır.",
  "wsl.onboarding.installNexocodeIn": "NexoCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installNexocode": "NexoCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NexoCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "NexoCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra NexoCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "NexoCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NexoCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı NexoCode komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (nexocode.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: NexoCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində NexoCode serverini işlət.",
  ...
  "settings.general.row.language.description": "NexoCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "NexoCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "NexoCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "NexoCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "NexoCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "NexoCode-un ən son versiyasından istifadə edirsiniz.",

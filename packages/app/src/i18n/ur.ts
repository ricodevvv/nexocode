export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "NexoCode مینو",
  ...
  "desktop.recovery.loadFailed": "NexoCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "NexoCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "NexoCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.nexocodeMissing": "اس ڈسٹری بیوشن میں nexocode انسٹال نہیں ہے",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.nexocodeNotInstalled": "{{distro}} میں NexoCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "NexoCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.nexocode.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.nexocode.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.nexocodeGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور NexoCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور NexoCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور NexoCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "nexocode.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس NexoCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingNexocodeIn": "{{distro}} میں NexoCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingNexocode": "NexoCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingNexocodeIn": "{{distro}} میں NexoCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateNexocodeIn": "{{distro}} میں NexoCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateNexocode": "NexoCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.nexocodeReady": "NexoCode تیار ہے۔",
  "wsl.onboarding.installNexocodeIn": "{{distro}} میں NexoCode انسٹال کریں۔",
  "wsl.onboarding.installNexocode": "NexoCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ NexoCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "NexoCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر NexoCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "NexoCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NexoCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم NexoCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (nexocode.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، NexoCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "NexoCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "NexoCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر NexoCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "NexoCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر NexoCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا NexoCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "NexoCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "NexoCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ NexoCode کا تازہ ترین ورژن چلا رہے ہیں۔",

...
export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "NexoCode-meny",
  ...
  "desktop.recovery.loadFailed": "NexoCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "NexoCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "NexoCode svarer ikke",
  ...
  "desktop.wsl.error.installNexocode": "Installasjonen av NexoCode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.nexocodeMissing": "nexocode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av NexoCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.nexocode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.nexocodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Besøk ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NexoCode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i nexocode.json",
  ...
  "dialog.server.description": "Bytt hvilken NexoCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NexoCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til NexoCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (nexocode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NexoCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør NexoCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NexoCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NexoCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om NexoCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i NexoCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NexoCode starter",
  ...
  "settings.updates.toast.latest.title": "NexoCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av NexoCode.",
  ...
  "wsl.onboarding.checkingNexocode": "Sjekker NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Sjekker NexoCode i {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Oppdaterer NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Oppdaterer NexoCode i {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Oppdater NexoCode i {{distro}}.",
  "wsl.onboarding.updateNexocode": "Oppdater NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode er klar i {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode er klar.",
  "wsl.onboarding.installNexocodeIn": "Installer NexoCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før NexoCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "NexoCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter NexoCode på nytt.",
  ...
  "help.tabs.introduction": "NexoCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":

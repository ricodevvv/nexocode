export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za NexoCode",
  ...
  "desktop.menu.ariaLabel": "NexoCode meni",
  ...
  "desktop.recovery.loadFailed": "NexoCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor NexoCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "NexoCode ne reaguje",
  ...
  "desktop.wsl.error.installNexocode": "Instalacija NexoCode-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.nexocodeMissing": "nexocode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje NexoCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.nexocode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.nexocodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u NexoCode-u.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Posjeti ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u NexoCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u NexoCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u nexocode.json",
  ...
  "dialog.server.description": "Promijeni na koji se NexoCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingNexocode": "Provjera NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Provjera NexoCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Ažuriranje NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Ažuriranje NexoCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Ažuriraj NexoCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateNexocode": "Ažuriraj NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode je spreman.",
  "wsl.onboarding.installNexocodeIn": "Instaliraj NexoCode u distribuciji {{distro}}.",
  "wsl.onboarding.installNexocode": "Instaliraj NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi NexoCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "NexoCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NexoCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku NexoCode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (nexocode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: NexoCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni NexoCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u NexoCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako NexoCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li NexoCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu NexoCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se NexoCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju NexoCode-a.",

export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja NexoCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać NexoCode",
  "desktop.recovery.terminated": "Okno NexoCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "NexoCode nie odpowiada",
  ...
  "desktop.wsl.error.installNexocode": "Nie udało się zainstalować NexoCode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.nexocodeMissing": "Program nexocode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.nexocodeCannotRun": "Program nexocode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja NexoCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.nexocode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.nexocodeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NexoCode.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku nexocode.json",
  ...
  "dialog.server.description": "Przełącz serwer NexoCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingNexocode": "Sprawdzanie NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Sprawdzanie NexoCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Aktualizowanie NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Aktualizowanie NexoCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Zaktualizuj NexoCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateNexocode": "Zaktualizuj NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode jest gotowy.",
  "wsl.onboarding.installNexocodeIn": "Zainstaluj NexoCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installNexocode": "Zainstaluj NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim NexoCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "NexoCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja NexoCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NexoCode",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (nexocode.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: NexoCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "NexoCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer NexoCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NexoCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd NexoCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NexoCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NexoCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NexoCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NexoCode.",

export const dict = {
  ...
  "desktop.recovery.loadFailed": "NexoCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "NexoCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "NexoCode ei vasta",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.nexocodeMissing": "nexocode pole sellesse distrosse installitud",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NexoCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.nexocode.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.nexocodeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid NexoCode'is.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Külastage ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises NexoCode.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis nexocode.json",
  ...
  "dialog.server.description": "Lülitage, millise NexoCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode kontrollimine...",
  "wsl.onboarding.checkingNexocodeIn": "NexoCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingNexocode": "NexoCode värskendamine...",
  "wsl.onboarding.updatingNexocodeIn": "NexoCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Värskenda NexoCode jaotises {{distro}}.",
  "wsl.onboarding.updateNexocode": "Värskenda NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode on valmis {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode on valmis.",
  "wsl.onboarding.installNexocodeIn": "Installige NexoCode asukohta {{distro}}.",
  "wsl.onboarding.installNexocode": "Installige NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui NexoCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "NexoCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse NexoCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast NexoCode meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (nexocode.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, NexoCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "NexoCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage NexoCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke NexoCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas NexoCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas NexoCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas NexoCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui NexoCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse NexoCode uusimat versiooni.",

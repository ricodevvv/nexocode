export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "NexoCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno NexoCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "NexoCode se ne odziva",
  ...
  "desktop.wsl.error.installNexocode": "Namestitev NexoCode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.nexocodeMissing": "nexocode ni nameščen v tej distribuciji",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev NexoCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.nexocode.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.nexocodeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Obisk ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v NexoCode.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v nexocode.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom NexoCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingNexocode": "Preverjanje NexoCode ...",
  "wsl.onboarding.checkingNexocodeIn": "Preverjanje NexoCode v {{distro}} ...",
  "wsl.onboarding.updatingNexocode": "Posodabljanje NexoCode ...",
  "wsl.onboarding.updatingNexocodeIn": "Posodabljanje NexoCode v {{distro}} ...",
  "wsl.onboarding.updateNexocodeIn": "Posodobite NexoCode v {{distro}}.",
  "wsl.onboarding.updateNexocode": "Posodobite NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode je pripravljen v {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode je pripravljen.",
  "wsl.onboarding.installNexocodeIn": "Namestite NexoCode v {{distro}}.",
  "wsl.onboarding.installNexocode": "Namestite NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko NexoCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "NexoCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica NexoCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi NexoCode",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (nexocode.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, NexoCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik NexoCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za NexoCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako NexoCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali NexoCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo NexoCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene NexoCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico NexoCode.",

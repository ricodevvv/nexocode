...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "NexoCode įkelti nepavyko",
  "NexoCode langas netikėtai užsidarė",
  "NexoCode neatsako",
  ...
  "NexoCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "nexocode šiame distributyve neįdiegtas",
  "nexocode įdiegtas, bet jo paleisti nepavyko",
  "NexoCode neįdiegtas distributyve {{distro}}",
  "NexoCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.nexocode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.nexocode.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.nexocodeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami NexoCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.nexocodeZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.nexocodeZen.visit.prefix": "Aplankykite",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius NexoCode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti nexocode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio NexoCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingNexocode": "Tikrinama NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Tikrinama NexoCode {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Atnaujinamas NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Atnaujinamas NexoCode {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Atnaujinkite NexoCode {{distro}}.",
  "wsl.onboarding.updateNexocode": "Atnaujinkite NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode yra paruoštas {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode yra paruoštas.",
  "wsl.onboarding.installNexocodeIn": "Įdiekite NexoCode į {{distro}}.",
  "wsl.onboarding.installNexocode": "Įdiekite NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad NexoCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "NexoCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują NexoCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą NexoCode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (nexocode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad NexoCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "NexoCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "NexoCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite NexoCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite NexoCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip NexoCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar NexoCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite NexoCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas NexoCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią NexoCode versiją.",

...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "NexoCode 載入失敗",
  "desktop.recovery.terminated": "NexoCode 視窗意外終止",
  "desktop.recovery.unresponsive": "NexoCode 沒有回應",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.nexocodeMissing": "此發行版中未安裝 nexocode",
  "desktop.wsl.error.nexocodeCannotRun": "已安裝 nexocode，但無法執行",
  "desktop.wsl.error.nexocodeNotInstalled": "{{distro}} 中未安裝 NexoCode",
  "desktop.wsl.error.updateVersion":
    "NexoCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.nexocode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.nexocode.tagline": "經過最佳化的可靠模型",
  "dialog.provider.nexocodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 NexoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.nexocodeZen.line1": "NexoCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.nexocodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.nexocodeZen.visit.prefix": "造訪 ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 NexoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 NexoCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 nexocode.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 NexoCode 伺服器。",
  ...
  "wsl.onboarding.checkingNexocode": "正在檢查 NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "正在檢查 {{distro}} 中的 NexoCode...",
  ...
  "wsl.onboarding.nexocodeReadyIn": "{{distro}} 中的 NexoCode 已就緒。",
  "wsl.onboarding.nexocodeReady": "NexoCode 已就緒。",
  "wsl.onboarding.installNexocodeIn": "在 {{distro}} 中安裝 NexoCode。",
  "wsl.onboarding.installNexocode": "安裝 NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "未安裝 NexoCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "NexoCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 NexoCode。",
  ...
  "help.tabs.introduction": "NexoCode Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NexoCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 NexoCode 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (nexocode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：NexoCode 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "NexoCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 NexoCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 NexoCode 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 NexoCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 NexoCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 NexoCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 NexoCode 啟動時自動檢查更新",

export const dict = {
  ...
  "dialog.provider.nexocode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.nexocode.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.nexocodeGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.nexocodeZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.nexocodeZen.visit.prefix": "Visita ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in NexoCode.",
  ...
  "dialog.plugins.empty": "Plugin configurati in nexocode.json",
  ...
  "dialog.server.description": "Cambia il server NexoCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingNexocode": "Controllo NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Controllo NexoCode in {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Aggiornamento NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Aggiornamento NexoCode in {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Aggiorna NexoCode in {{distro}}.",
  "wsl.onboarding.updateNexocode": "Aggiorna NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode è pronto in {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode è pronto.",
  "wsl.onboarding.installNexocodeIn": "Installa NexoCode in {{distro}}.",
  "wsl.onboarding.installNexocode": "Installa NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che NexoCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "NexoCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di NexoCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team NexoCode",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (nexocode.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: NexoCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server NexoCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per NexoCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di NexoCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se NexoCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di NexoCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di NexoCode",
  ...
  "settings.updates.toast.latest.title": "NexoCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di NexoCode.",
  ...
  "desktop.menu.documentation": "Documentazione di NexoCode",
  ...
  "desktop.menu.ariaLabel": "Menu NexoCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare NexoCode",
  "desktop.recovery.terminated": "La finestra di NexoCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "NexoCode non risponde",
  ...
  "desktop.wsl.error.installNexocode": "Installazione di NexoCode non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.nexocodeMissing": "nexocode non è installato in questa distribuzione",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di NexoCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",

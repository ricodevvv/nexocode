export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'NexoCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'NexoCode",
  "desktop.recovery.terminated": "La fenêtre NexoCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "NexoCode ne répond pas",
  ...
  "desktop.wsl.error.installNexocode": "Échec de l'installation d'NexoCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.nexocodeMissing": "nexocode n'est pas installé dans cette distribution",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'NexoCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.nexocode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.nexocodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Visitez ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NexoCode.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans nexocode.json",
  ...
  "dialog.server.description": "Changez le serveur NexoCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingNexocode": "Vérification d'NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Vérification d'NexoCode dans {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Mise à jour d'NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Mise à jour d'NexoCode dans {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Mettez à jour NexoCode dans {{distro}}.",
  "wsl.onboarding.updateNexocode": "Mettre à jour NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode est prêt dans {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode est prêt.",
  "wsl.onboarding.installNexocodeIn": "Installez NexoCode dans {{distro}}.",
  "wsl.onboarding.installNexocode": "Installer NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'NexoCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "NexoCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'NexoCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe NexoCode",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (nexocode.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'NexoCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "NexoCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur NexoCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour NexoCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NexoCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NexoCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'NexoCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NexoCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NexoCode.",

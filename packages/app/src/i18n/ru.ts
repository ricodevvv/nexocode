export const dict = {
  ...
  "desktop.menu.documentation": "Документация NexoCode",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить NexoCode",
  "desktop.recovery.terminated": "Окно NexoCode неожиданно завершило работу",
  "desktop.recovery.unresponsive": "NexoCode не отвечает",
  ...
  "desktop.wsl.error.installNexocode": "Не удалось установить NexoCode",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.nexocodeMissing": "nexocode не установлен в этом дистрибутиве",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode установлен, но его не удалось запустить",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление NexoCode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.nexocode.tagline": "Надёжные оптимизированные модели",
  "dialog.provider.nexocodeGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.nexocodeZen.visit.suffix": ", чтобы получить ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в NexoCode.",
  ...
  "dialog.plugins.empty": "Плагины настроены в nexocode.json",
  ...
  "dialog.server.description": "Выберите сервер NexoCode, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingNexocode": "Проверка NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Проверка NexoCode в {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Обновление NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Обновление NexoCode в {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Обновите NexoCode в {{distro}}.",
  "wsl.onboarding.updateNexocode": "Обновить NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode в {{distro}} готов к работе.",
  "wsl.onboarding.nexocodeReady": "NexoCode готов к работе.",
  "wsl.onboarding.installNexocodeIn": "Установите NexoCode в {{distro}}.",
  "wsl.onboarding.installNexocode": "Установить NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в NexoCode требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "NexoCode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте NexoCode.",
  ...
  "help.tabs.introduction": "Теперь работа в NexoCode Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия NexoCode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде NexoCode",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (nexocode.json)",
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: NexoCode пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер NexoCode внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения NexoCode",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид NexoCode на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли NexoCode системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление NexoCode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске NexoCode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию NexoCode.",

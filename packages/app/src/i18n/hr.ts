...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "NexoCode se nije uspio učitati",
  "Prozor aplikacije NexoCode neočekivano je zatvoren",
  "NexoCode ne reagira",
  ...
  "Instalacija aplikacije NexoCode nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "nexocode nije instaliran u ovoj distribuciji",
  "nexocode je instaliran, ali se ne može pokrenuti",
  "NexoCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije NexoCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.nexocode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.nexocode.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.nexocodeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Posjetiti",
  "provider.connect.nexocodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u NexoCode.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u nexocode.json",
  ...
  "dialog.server.description": "Promijenite na koji se NexoCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingNexocodeIn": "Provjera NexoCode u {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Ažuriranje NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Ažuriranje NexoCode u {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Ažurirajte NexoCode u {{distro}}.",
  "wsl.onboarding.updateNexocode": "Ažurirajte NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode je spreman u {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode je spreman.",
  "wsl.onboarding.installNexocodeIn": "Instalirajte NexoCode u {{distro}}.",
  "wsl.onboarding.installNexocode": "Instalirajte NexoCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što NexoCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "NexoCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite NexoCode.",
  ...
  "help.tabs.introduction": "Radna površina NexoCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NexoCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku NexoCode timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (nexocode.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, NexoCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "NexoCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite NexoCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za NexoCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako NexoCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li NexoCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je NexoCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se NexoCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju NexoCode.",

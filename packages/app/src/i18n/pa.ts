export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "NexoCode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "NexoCode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "NexoCode جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.nexocodeMissing": "اس ڈسٹرو وچ nexocode انسٹال نئیں اے",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.nexocodeNotInstalled": "{{distro}} وچ NexoCode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "NexoCode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.nexocode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.nexocode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.nexocodeGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے NexoCode وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "ویکھو ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے NexoCode وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے NexoCode وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "nexocode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس NexoCode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode چیک کر رئے آں...",
  "wsl.onboarding.checkingNexocodeIn": "{{distro}} چ NexoCode دی جانچ پڑتال...",
  "wsl.onboarding.updatingNexocode": "NexoCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingNexocodeIn": "{{distro}} وچ NexoCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateNexocodeIn": "{{distro}} وچ NexoCode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateNexocode": "NexoCode اپ ڈیٹ کرو",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.nexocodeReady": "NexoCode تیار اے۔",
  "wsl.onboarding.installNexocodeIn": "{{distro}} وچ NexoCode انسٹال کرو۔",
  "wsl.onboarding.installNexocode": "NexoCode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NexoCode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "NexoCode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر NexoCode دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "NexoCode Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NexoCode ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع NexoCode ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (nexocode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، NexoCode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "NexoCode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر NexoCode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "NexoCode لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے NexoCode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا NexoCode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "NexoCode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں NexoCode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی NexoCode دا تازہ ترین ورژن چلا رئے او۔",

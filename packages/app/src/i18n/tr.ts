...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "NexoCode yüklenemedi",
  "desktop.recovery.terminated": "NexoCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "NexoCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.nexocodeMissing": "nexocode bu dağıtımda kurulu değil",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "NexoCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.nexocode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.nexocodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve NexoCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.nexocodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak NexoCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak NexoCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler nexocode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi NexoCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode kontrol ediliyor...",
  "wsl.onboarding.checkingNexocodeIn": "{{distro}} içinde NexoCode kontrol ediliyor...",
  "wsl.onboarding.updatingNexocode": "NexoCode güncelleniyor...",
  "wsl.onboarding.updatingNexocodeIn": "{{distro}} içinde NexoCode güncelleniyor...",
  "wsl.onboarding.updateNexocodeIn": "{{distro}} içindeki NexoCode'u güncelleyin.",
  "wsl.onboarding.updateNexocode": "NexoCode'u güncelle",
  "wsl.onboarding.nexocodeReadyIn": "{{distro}} içinde NexoCode hazır.",
  "wsl.onboarding.nexocodeReady": "NexoCode hazır.",
  "wsl.onboarding.installNexocodeIn": "NexoCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installNexocode": "NexoCode'u kur",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NexoCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "NexoCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından NexoCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "NexoCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NexoCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı NexoCode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (nexocode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: NexoCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "NexoCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "NexoCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "NexoCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "NexoCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "NexoCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "NexoCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "NexoCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "NexoCode'un en son sürümünü kullanıyorsunuz.",

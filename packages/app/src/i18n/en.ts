...
export const dict = {
  ...
  "dialog.provider.nexocode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.nexocode.tagline": "Reliable optimized models",
  "dialog.provider.nexocodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in NexoCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.nexocodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.nexocodeZen.visit.prefix": "Visit ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in NexoCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in nexocode.json",
  ...
  "dialog.server.description": "Switch which NexoCode server this app connects to.",
  ...
  "wsl.onboarding.checkingNexocode": "Checking NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "Checking NexoCode in {{distro}}...",
  "wsl.onboarding.updatingNexocode": "Updating NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "Updating NexoCode in {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Update NexoCode in {{distro}}.",
  "wsl.onboarding.updateNexocode": "Update NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode is ready in {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode is ready.",
  "wsl.onboarding.installNexocodeIn": "Install NexoCode in {{distro}}.",
  "wsl.onboarding.installNexocode": "Install NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before NexoCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "NexoCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen NexoCode.",
  ...
  "help.tabs.introduction": "NexoCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of NexoCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the NexoCode team",
  ...
  "error.chain.checkConfig": "Check your config (nexocode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, NexoCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the NexoCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for NexoCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how NexoCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether NexoCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how NexoCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when NexoCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of NexoCode.",

export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "NexoCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het NexoCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "NexoCode reageert niet",
  ...
  "desktop.wsl.error.installNexocode": "Installatie van NexoCode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.nexocodeMissing": "nexocode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De NexoCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.nexocode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.nexocodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door NexoCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in NexoCode te gebruiken.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.nexocodeZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.nexocodeZen.visit.prefix": "Ga naar ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in NexoCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in NexoCode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in nexocode.json",
  ...
  "dialog.server.description": "Wijzig met welke NexoCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode controleren...",
  "wsl.onboarding.checkingNexocodeIn": "NexoCode controleren in {{distro}}...",
  "wsl.onboarding.updatingNexocode": "NexoCode bijwerken...",
  "wsl.onboarding.updatingNexocodeIn": "NexoCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "Werk NexoCode bij in {{distro}}.",
  "wsl.onboarding.updateNexocode": "NexoCode bijwerken",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode is gereed in {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode is klaar.",
  "wsl.onboarding.installNexocodeIn": "Installeer NexoCode in {{distro}}.",
  "wsl.onboarding.installNexocode": "Installeer NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat NexoCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "NexoCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens NexoCode opnieuw.",
  ...
  "help.tabs.introduction": "NexoCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van NexoCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het NexoCode-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (nexocode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: NexoCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de NexoCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor NexoCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe NexoCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of NexoCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van NexoCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer NexoCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "NexoCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van NexoCode.",

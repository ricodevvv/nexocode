export const dict = {
  ...
  "desktop.menu.documentation": "NexoCode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "NexoCode menýusy",
  ...
  "desktop.recovery.loadFailed": "NexoCode ýükläp bilmedi",
  "desktop.recovery.terminated": "NexoCode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "NexoCode jogap berenok",
  ...
  "desktop.wsl.error.installNexocode": "NexoCode gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.nexocodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "NexoCode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.nexocode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.nexocode.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.nexocodeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "NexoCode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we NexoCode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.nexocodeZen.line1":
    "NexoCode Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "Sapar ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini NexoCode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini NexoCode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "nexocode.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy NexoCode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingNexocode": "NexoCode barlamak ...",
  "wsl.onboarding.checkingNexocodeIn": "{{distro}} içinde NexoCode barlanýar...",
  "wsl.onboarding.updatingNexocode": "NexoCode täzelenmek ...",
  "wsl.onboarding.updatingNexocodeIn": "{{distro}}-de NexoCode täzelenmek ...",
  "wsl.onboarding.updateNexocodeIn": "NexoCode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateNexocode": "NexoCode täzeläň",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode {{distro}}-de taýýar.",
  "wsl.onboarding.nexocodeReady": "NexoCode taýýar.",
  "wsl.onboarding.installNexocodeIn": "{{distro}}-de NexoCode guruň.",
  "wsl.onboarding.installNexocode": "NexoCode guruň",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) NexoCode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "NexoCode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra NexoCode açyň.",
  ...
  "help.tabs.introduction": "NexoCode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin NexoCode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy NexoCode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (nexocode.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, NexoCode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "NexoCode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "NexoCode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "NexoCode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "NexoCode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "NexoCode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "NexoCode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "NexoCode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "NexoCode-iň iň soňky wersiýasyny işleýärsiňiz.",

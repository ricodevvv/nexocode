export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل NexoCode",
  "desktop.recovery.terminated": "توقفت نافذة NexoCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "NexoCode لا يستجيب",
  ...
  "desktop.wsl.error.installNexocode": "فشل تثبيت NexoCode",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.nexocodeMissing": "nexocode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.nexocodeCannotRun": "nexocode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.nexocodeNotInstalled": "NexoCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث NexoCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.nexocode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.nexocode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.nexocodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من NexoCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في NexoCode.",
  ...
  "provider.connect.nexocodeZen.line1":
    "يمنحك NexoCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.nexocodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.nexocodeZen.visit.link": "nexocode.ai/zen",
  "provider.connect.nexocodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NexoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في NexoCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في nexocode.json",
  ...
  "dialog.server.description": "تبديل خادم NexoCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingNexocode": "جارٍ التحقق من NexoCode...",
  "wsl.onboarding.checkingNexocodeIn": "جارٍ التحقق من NexoCode في {{distro}}...",
  "wsl.onboarding.updatingNexocode": "جارٍ تحديث NexoCode...",
  "wsl.onboarding.updatingNexocodeIn": "جارٍ تحديث NexoCode في {{distro}}...",
  "wsl.onboarding.updateNexocodeIn": "حدّث NexoCode في {{distro}}.",
  "wsl.onboarding.updateNexocode": "تحديث NexoCode",
  "wsl.onboarding.nexocodeReadyIn": "NexoCode جاهز في {{distro}}.",
  "wsl.onboarding.nexocodeReady": "NexoCode جاهز.",
  "wsl.onboarding.installNexocodeIn": "ثبّت NexoCode في {{distro}}.",
  "wsl.onboarding.installNexocode": "تثبيت NexoCode",
  ...
  "wsl.onboarding.distroStatus.nexocodeMissing": "NexoCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن NexoCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على NexoCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح NexoCode.",
  ...
  "help.tabs.introduction": "أصبح NexoCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من NexoCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق NexoCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (nexocode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن NexoCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن NexoCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم NexoCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ NexoCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور NexoCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان NexoCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة NexoCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل NexoCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من NexoCode.",

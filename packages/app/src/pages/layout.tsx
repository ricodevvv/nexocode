...
import { Session } from "@nexocode-ai/sdk/v2/client"
...
import { retry } from "@nexocode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@nexocode-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://nexocode.ai/desktop-feedback")}
      renderPanel={() =>

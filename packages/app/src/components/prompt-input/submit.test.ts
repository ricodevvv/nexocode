...
beforeAll(async () => {
  ...
  mock.module("@nexocode-ai/sdk/v2/client", () => ({
    createNexocodeClient: (input: { directory: string }) => {
      createdClients.push(input.directory)
      return clientFor(input.directory)
    },
  }))

  mock.module("@nexocode-ai/ui/toast", () => ({
    Toast: { Region: () => null },
    showToast: () => 0,
  }))

  mock.module("@nexocode-ai/core/util/encode", () => ({

...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "nexocode", key: "dialog.provider.nexocode.note" },
  { match: (id: string) => id === "nexocode-go", key: "dialog.provider.nexocodeGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "nexocode" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "nexocode" || item.id === "nexocode-go"}>

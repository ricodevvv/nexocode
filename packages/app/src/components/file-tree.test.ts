...
beforeAll(async () => {
  ...
  mock.module("@nexocode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nexocode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nexocode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nexocode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

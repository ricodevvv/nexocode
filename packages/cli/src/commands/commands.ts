...
declare const NEXOCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof NEXOCODE_CLI_NAME === "string" ? NEXOCODE_CLI_NAME : "nexocode", {
  description: "NexoCode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {

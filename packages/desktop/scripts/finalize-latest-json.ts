...
const releaseId = process.env.NEXOCODE_RELEASE
if (!releaseId) throw new Error("NEXOCODE_RELEASE is required")

const version = process.env.NEXOCODE_VERSION
if (!version) throw new Error("NEXOCODE_VERSION is required")
...
const macxTarGz = "nexocode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "nexocode-desktop-mac-arm64.app.tar.gz"

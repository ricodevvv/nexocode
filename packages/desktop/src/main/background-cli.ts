...
const desktopStateNames = ["ai.nexocode.desktop.dev", "ai.nexocode.desktop.beta", "ai.nexocode.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "nexocode-cli.exe" : "nexocode-cli"
}

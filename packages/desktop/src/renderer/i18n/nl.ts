export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van NexoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van NexoCode is gedownload. Wil je deze installeren en NexoCode opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'nexocode' te gebruiken.",

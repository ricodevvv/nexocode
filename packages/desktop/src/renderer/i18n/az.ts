export const dict = {
  ...
  "desktop.updater.none.message": "Artıq NexoCode-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "NexoCode-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'nexocode' əmrindən istifadə etmək üçün terminalı yenidən başladın.",

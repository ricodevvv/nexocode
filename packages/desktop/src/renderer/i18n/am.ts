export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የNexoCode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከNexoCode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",

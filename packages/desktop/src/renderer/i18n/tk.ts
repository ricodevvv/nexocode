export const dict = {
  ...
  "desktop.updater.none.message": "NexoCode-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "NexoCode-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'nexocode' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",

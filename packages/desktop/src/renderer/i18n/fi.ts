export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo NexoCoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "NexoCoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää NexoCoden uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'nexocode'-komentoa.",

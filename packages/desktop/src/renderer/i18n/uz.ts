export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon NexoCode ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "NexoCodening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'nexocode' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",

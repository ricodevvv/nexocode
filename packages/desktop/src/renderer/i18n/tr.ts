export const dict = {
  ...
  "desktop.updater.none.message": "NexoCode'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "NexoCode'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'nexocode' komutunu kullanmak için terminalinizi yeniden başlatın.",

...
import type * as SDK from "@nexocode-ai/sdk/v2"
...
import { SessionShareTable } from "@nexocode-ai/core/share/sql"
...
const disabled = process.env["NEXOCODE_DISABLE_SHARE"] === "true" || process.env["NEXOCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/ShareNext") {}

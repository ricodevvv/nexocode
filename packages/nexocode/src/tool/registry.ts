...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@nexocode-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return (
    ...
    providerID === ProviderV2.ID.make("nexocode-go") ||
    flags.exa ||
    flags.parallel
  )
}
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/ToolRegistry") {}

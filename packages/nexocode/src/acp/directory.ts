...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@nexocode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@nexocode/ACPDirectory") {}

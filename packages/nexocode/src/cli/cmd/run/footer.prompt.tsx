...
import { normalizePromptContent } from "@nexocode-ai/tui/editor"
...
import { NEXOCODE_BASE_MODE, useBindings } from "@nexocode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close NexoCode" } satisfies SlashOption,
    ]

...
import { openEditor } from "@nexocode-ai/tui/editor"
import { registerNexocodeKeymap } from "@nexocode-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerNexocodeKeymap(keymap, renderer, input.tuiConfig)

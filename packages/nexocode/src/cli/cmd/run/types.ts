// Shared type vocabulary for the direct interactive mode (`nexocode --mini`).
//
...
import type { NexocodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@nexocode-ai/sdk/v2"
import type { TuiConfig } from "@nexocode-ai/tui/config"
...
type PromptModel = Parameters<NexocodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<NexocodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<NexocodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<NexocodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<NexocodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<NexocodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<NexocodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<NexocodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<NexocodeClient["question"]["reject"]>[0]

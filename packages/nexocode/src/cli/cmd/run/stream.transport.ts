...
import type { Event, GlobalEvent, NexocodeClient } from "@nexocode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@nexocode/RunStreamTransport") {}

...
//
// The saved variant persists across sessions in ~/.local/state/nexocode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@nexocode/RunVariant") {}

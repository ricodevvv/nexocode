...
import { NexoCodeHttpApi } from "./api"
...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for nexocode serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(NexoCodeHttpApi)
...
export const PublicApi = NexoCodeHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "nexocode",
    version: "1.0.0",
    description: "nexocode api",

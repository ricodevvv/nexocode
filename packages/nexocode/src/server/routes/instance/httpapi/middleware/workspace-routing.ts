...
>()("@nexocode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@nexocode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.NEXOCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.NEXOCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-nexocode-directory"] || process.cwd()
}

...
import { SkillPlugin } from "@nexocode-ai/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@nexocode-ai/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@nexocode-ai/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@nexocode-ai/core/util/glob"
...
const NEXOCODE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
const SKILL_PATTERN = "**/SKILL.md"

// Built-in skill that ships with nexocode. The model's intuition for what an
// nexocode.json should look like is often wrong, and nexocode hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch nexocode's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_NEXOCODE_SKILL_NAME = "customize-nexocode"
const CUSTOMIZE_NEXOCODE_SKILL_DESCRIPTION =
...
const CUSTOMIZE_NEXOCODE_SKILL_BODY = SkillPlugin.CustomizeNexocodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, NEXOCODE_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_NEXOCODE_SKILL_NAME] = {
          name: CUSTOMIZE_NEXOCODE_SKILL_NAME,
          description: CUSTOMIZE_NEXOCODE_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_NEXOCODE_SKILL_BODY,
        }

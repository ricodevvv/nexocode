 ...
 *   "@nexocode/ServerAuthConfig",
 *   {
 *     password: Config.string("NEXOCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("NEXOCODE_SERVER_USERNAME").pipe(Config.withDefault("nexocode")),
 *   },
 * ) {}
 *

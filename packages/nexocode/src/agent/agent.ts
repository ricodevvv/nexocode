...
import { AbsolutePath, type DeepMutable } from "@nexocode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".nexocode", "plans", "*.md")]: "allow",

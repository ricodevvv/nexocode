import type { JsonSchema, LLMRequest, ProviderMetadata } from "@nexocode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@nexocode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @nexocode-ai/llm request objects from nexocode's session/AI SDK-shaped data.
  return LLM.request({

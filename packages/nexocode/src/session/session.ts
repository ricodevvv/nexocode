...
import { Slug } from "@nexocode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@nexocode-ai/llm"
...
import { locationServiceMapLayer } from "@nexocode-ai/core/location-services"
...
import { PartTable, SessionTable } from "@nexocode-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@nexocode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".nexocode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/Session") {}

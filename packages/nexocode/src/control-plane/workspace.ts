...
import { EventSequenceTable, EventTable } from "@nexocode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@nexocode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        NEXOCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        NEXOCODE_WORKSPACE_ID: config.id,
        NEXOCODE_EXPERIMENTAL_WORKSPACES: "true",

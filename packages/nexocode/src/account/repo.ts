...
import { AccountStateTable, AccountTable } from "@nexocode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/AccountRepo") {}

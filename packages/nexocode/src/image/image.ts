...
export class Service extends Context.Service<Service, Interface>()("@nexocode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __NEXOCODE_PHOTON_WASM_PATH?: string }).__NEXOCODE_PHOTON_WASM_PATH =

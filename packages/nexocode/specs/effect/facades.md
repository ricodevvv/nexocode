...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/nexocode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy nexocode service removed

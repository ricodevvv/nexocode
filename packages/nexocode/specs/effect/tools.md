...
Practical reference for the current tool-migration state in `packages/nexocode`.
...
Tool tests should use the existing Effect helpers in `packages/nexocode/test/lib/effect.ts`:

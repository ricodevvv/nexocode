...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NEXOCODE_CALLER", () => {
    process.env["NEXOCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NEXOCODE_CALLER", () => {
    process.env["NEXOCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NEXOCODE_CALLER", () => {
    process.env["NEXOCODE_CALLER"] = "unknown"

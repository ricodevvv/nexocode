...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips nexocode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-nexocode-directory"]).toBeUndefined()
      expect(forwarded["x-nexocode-workspace"]).toBeUndefined()

...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips nexocode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-nexocode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-nexocode-directory")).toBeNull()
      expect(result.get("x-nexocode-workspace")).toBeNull()

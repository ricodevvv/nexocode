...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/ricodevvv/nexocode.git")).toEqual({ owner: "sst", repo: "nexocode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/ricodevvv/nexocode")).toEqual({ owner: "sst", repo: "nexocode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:ricodevvv/nexocode.git")).toEqual({ owner: "sst", repo: "nexocode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:ricodevvv/nexocode")).toEqual({ owner: "sst", repo: "nexocode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/ricodevvv/nexocode.git")).toEqual({ owner: "sst", repo: "nexocode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/ricodevvv/nexocode")).toEqual({ owner: "sst", repo: "nexocode" })
})

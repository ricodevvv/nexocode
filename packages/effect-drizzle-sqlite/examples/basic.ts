...
class Database extends Context.Service<Database, DatabaseShape>()("@nexocode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@nexocode/example/UserStore") {

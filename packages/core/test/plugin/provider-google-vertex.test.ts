...
import { GoogleVertexPlugin } from "@nexocode-ai/core/plugin/provider/google-vertex"
      ...
      yield* catalog.transform((catalog) =>
        catalog.provider.update(ProviderV2.ID.nexocode, (provider) => {
          provider.api = {
            ...
            url: "https://nexocode.ai/zen/v1",
          }
        }),
      )
      yield* addPlugin()

      const provider = required(yield* catalog.provider.get(ProviderV2.ID.nexocode))

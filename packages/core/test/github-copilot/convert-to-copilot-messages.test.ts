import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@nexocode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"

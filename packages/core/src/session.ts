...
import { ListAnchor } from "@nexocode-ai/schema/session"
...
import { SessionDurable } from "@nexocode-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/v2/Session") {}

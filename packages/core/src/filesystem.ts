...
import { Entry, FileSystem, FindInput, Match } from "@nexocode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@nexocode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/v2/FileSystem") {}

...
import { FileSystemWatcher } from "@nexocode-ai/schema/filesystem-watcher"
...
declare const NEXOCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof NEXOCODE_LIBC === "undefined" ? undefined : NEXOCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.NEXOCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.NEXOCODE_EXPERIMENTAL_FILEWATCHER)) {

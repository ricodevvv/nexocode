...
import type { Plugin as PluginRuntime } from "@nexocode-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/v2/Plugin") {}

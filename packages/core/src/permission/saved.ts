...
import { PermissionSaved } from "@nexocode-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/v2/PermissionSaved") {}

...
import type { EffectDrizzleSqlite } from "@nexocode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/ProjectDirectories") {}

...
import type { Data, Definition, Payload } from "@nexocode-ai/schema/event"
...
import { Durable } from "@nexocode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@nexocode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@nexocode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/Event") {}

...
import { ToolFailure } from "@nexocode-ai/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("@nexocode/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.NEXOCODE_WEBSEARCH_PROVIDER === "exa" || process.env.NEXOCODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.NEXOCODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("NEXOCODE_EXPERIMENTAL") || truthy("NEXOCODE_ENABLE_EXA") || truthy("NEXOCODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("NEXOCODE_ENABLE_PARALLEL") || truthy("NEXOCODE_EXPERIMENTAL_PARALLEL"),
              ...
              const text =
                provider === "exa"
                  ...
                  : yield* callMcp(
                      ...
                      {
                        "User-Agent": `nexocode/${InstallationVersion}`,

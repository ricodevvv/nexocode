...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@nexocode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@nexocode/v2/ToolRegistry") {}

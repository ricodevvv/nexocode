...
brew install ricodevvv/tap/nexocode # macOS 和 Linux（推荐，始终保持最新）
brew install nexocode              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S nexocode            # Arch Linux (Stable)
paru -S nexocode-bin               # Arch Linux (Latest from AUR)
mise use -g nexocode               # 任意系统
nix run nixpkgs#nexocode           # 或用 github:ricodevvv/nexocode 获取最新 dev 分支
```
...
NexoCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/ricodevvv/nexocode/releases) 或 [nexocode.ai/download](https://nexocode.ai/download) 下载。
...
1. `$NEXOCODE_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.nexocode/bin` - 默认备用路径
...
NexoCode 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://nexocode.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://nexocode.ai/docs)。
...
如果你在项目名中使用了 “nexocode”（如 “nexocode-dashboard” 或 “nexocode-mobile”），请在 README 里注明该项目不是 NexoCode 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=52ao9352-5623-4fa0-b7dd-3407c392c1af&qr_code=true) | [X.com](https://x.com/nexocode)
